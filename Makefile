...
evidence-index:
	python3 ./scripts/evidence-index.py

evidence-index-doc:
	python3 ./scripts/evidence-index.py --markdown > docs/evidence-index.md
...
remaining-gates-doc:
	python3 ./scripts/remaining-gates-preflight.py --markdown > docs/remaining-gates-preflight.md

remaining-gates-runbook:
	python3 ./scripts/remaining-gates-preflight.py --runbook > docs/remaining-gates-supervised-runbook.md
